...
public class PaymentRepositoryTest
{
    ...
    [Fact]
    public void ShouldUpdateThePaymentName()
    {
        //Given
        Payment payment = PaymentFixture.Build();
        _sut.Add(payment);
        ...
        //When
        Payment newPayment = _sut.GetByID(1) with { ViaOfPayment = PaymentMethod.TC };
        _sut.Update(newPayment);

        //Then
        Payment? updatedPayment = _sut.GetByID(1);
        Assert.Equal(PaymentMethod.TC, updatedPayment?.ViaOfPayment);
    }
}
