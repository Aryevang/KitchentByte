...
public class PaymentRepository : IPaymentRepository
{
    ...
    public void Update(Payment model)
    {
        ...
        {
           paymentToUpdate.ProcessedOrder = model.ProcessedOrder;
           paymentToUpdate.TotalPaid = model.TotalPaid;
           paymentToUpdate.ViaOfPayment = model.ViaOfPayment;
           paymentToUpdate.Status = model.Status;
        }
    }
}
